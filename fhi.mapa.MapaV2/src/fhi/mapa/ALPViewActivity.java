...
public class ALPViewActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.webviewalp);
		 ...
		 btnALP = (Button)findViewById(R.id.Btnident);
		...
		webView.loadUrl("http://www.fhi360guatemala.org/android/kenya_alp.php?cod="+bundle.getString("codigo")+"&db="+database+"&nivel="+bundle.getString("niv"));
		//Boton Map
