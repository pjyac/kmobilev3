...
public class VocViewActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.webviewvoc);
		 ...
		 btnVoc = (Button)findViewById(R.id.Btnident);
		...
		webView.loadUrl("http://www.fhi360guatemala.org/android/kenya_vocV2.php?cod="+bundle.getString("codigo")+"&db="+database+"&nivel="+bundle.getString("niv"));
		//Boton Map
	    ...
	    public boolean onOptionsItemSelected(MenuItem item) {
	 	   switch (item.getItemId()) {
	 	        case R.id.item2:
	 	           ...
	 	           Intent intent = new Intent(getApplicationContext(), VocViewActivity.class);
	 	        ...
	 	        case R.id.item3:
	 	           ...
	 	           Intent intent2 = new Intent(getApplicationContext(), VocViewActivity.class);
	 	       ...
	 	       case R.id.item4:
		           ...
		           Intent intent3 = new Intent(getApplicationContext(), VocViewActivity.class);
		           String codigo = MyOverlay.codigo();
